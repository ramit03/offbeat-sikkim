...
export const UpcomingTours: TripDetail[] = [
  {
    ...
    originalPrice: "",
    currentPrice: "₹22,499/-",
    link: "upcoming-tours/north-sikkim-tour-nathula-pass",
    detailedItinerary: [
      {
        day: "Day 1",
        title:
  ...
  },
  {
    ...
    durationn: "5",
    durationd: "6",
    costDouble: "13,999/- Per Head",
    constTriple: "14,999/- Per Head",
    link: "upcoming-tours/sandakhpu-trek",
    detailedItinerary: [
      {
        day: "Day 1",
...
export const CuratedPackages: TripDetail[] = [
  {
    ...
    durationn: "5",
    durationd: "6",
    link: "curated-packages/meghalaya",
    detailedItinerary: [
      {
        day: "Day 1",
        title: "Guwahati Arrival | Umiam Lake | Overnight at Shillong",
  ...
  },
  {
    ...
    durationn: "5",
    durationd: "6",
    link: "curated-packages/nagaland",
    detailedItinerary: [
      {
        day: "Day 1",
  ...
  },
  {
    ...
    durationn: "4",
    durationd: "5",
    link: "curated-packages/north-sikkim-4nights-5days",
    detailedItinerary: [
      {
        day: "Day 1",
        title:
  ...
  },
  {
    ...
    durationn: "5",
    durationd: "6",
    link: "curated-packages/north-sikkim-tour-nathula-pass",
    detailedItinerary: [
      {
        day: "Day 1",
        title:
  ...
  },
  {
    ...
    durationn: "7",
    durationd: "8",
    link: "curated-packages/north-sikkim-nathula-pass-pelling",
    detailedItinerary: [
      {
        day: "Day 1",
        title:
  ...
  },
  {
    ...
    durationn: "3",
    durationd: "4",
    link: "curated-packages/pelling-tour",
    detailedItinerary: [
        {
            day: "Day 1",
